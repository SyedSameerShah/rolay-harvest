...
const Concentrated = () => {
  ...
  const filteredProducts = concentratedData.filter(product => {
          ...
          >
            {filteredProducts.map((product, index) => (
              <motion.div
                ...
                custom={index}
              >
                <ProductCard product={product} category="concentrated" />
              </motion.div>
            ))}
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">
                {i18n.language === 'ar' ? 'اقتصادي وفعال' : 'Economical and efficient'}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                {i18n.language === 'ar' ? 'مثالي لمختلف التطبيقات' : 'Perfect for various applications'}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                {i18n.language === 'ar' ? 'جودة إيطالية أصيلة' : 'Authentic Italian quality'}
              </p>
            </motion.div>
          </div>
        </div>
