...
const Footer = () => {
  ...
  return (
    <footer className="bg-navy text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products/slushes" className="text-gray-300 hover:text-gold transition-colors">
                  {t('nav.slushes')}
                </Link>
              </li>
              <li>
                <Link to="/products/concentrated" className="text-gray-300 hover:text-gold transition-colors">
                  {t('nav.concentrated')}
                </Link>
              </li>
              <li>
                <Link to="/products/ready-to-use" className="text-gray-300 hover:text-gold transition-colors">
                  {t('nav.readyToUse')}
                </Link>
              </li>
              <li>
                <Link to="/products/ice-cream" className="text-gray-300 hover:text-gold transition-colors">
                  {t('nav.iceCream')}
                </Link>
              </li>
            </ul>
      ...
      <motion.button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 bg-gold text-white p-3 rounded-full shadow-lg hover:bg-gold-dark transition-colors z-40"
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.9 }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
